            ...
            <div class="card-body">
              <div class="mb-3">
                ...
                <input type="text"
                  ...
                  placeholder="Title Article" name="title" value="{{ old('title', $article->title) }}" required>
                  @error('title')
              ...
              <div class="mb-3">
                ...
                <select
                  ...
                  @if (old('category_id', $article->category_id) == $item->id)
              ...
              <div class="mb-3">
                  ...
                  @if ($article->image)
                    <img src="{{ asset('storage/' . $article->image) }}" class="img-preview img-fluid mb-3 col-sm-2">
                  @else
                    <img class="img-preview img-fluid mb-3 col-sm-2">
                  @endif
                  <input
                    class="form-control @error('image') is-invalid @endif" type="file" name="image" id="image" onchange="previewImage()">
                  @error('image')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
              </div>
